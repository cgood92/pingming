...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(67), __webpack_require__(72)))
...
var keyChange$ = _Rx2.default.Observable.create(function (observer) {
	var map = {};
	...
	_Rx2.default.Observable.interval(30).subscribe(function () {
		return Object.keys(map).filter(function (i) {
			return map[i] === true;
		}).map(function (i) {
			return observer.next(Number(i));
		});
	});
});

var MoveableObject = function () {
	function MoveableObject(domRepresentation) {
		var _this = this;
		...
		Object.defineProperty(this, 'keepInBounds', {
			enumerable: true,
			writable: true,
			value: function value(oldVal, newVal, bufferSpace) {
		...
		Object.defineProperty(this, 'isCollidingWith', {
			enumerable: true,
			writable: true,
			value: function value(otherDomRepresentation) {
				var myDom = _this.domRepresentation;
				var otherDom = otherDomRepresentation.domRepresentation;
				return (
					// Within the x-axis
					myDom.offsetLeft > otherDom.offsetLeft && myDom.offsetLeft < otherDom.offsetLeft + otherDom.offsetWidth &&
					// Within the y-axis
					myDom.offsetTop > otherDom.offsetTop && myDom.offsetTop < otherDom.offsetTop + otherDom.offsetHeight
				);
			}
		});
...
var Ship = function (_MoveableObject) {
	_inherits(Ship, _MoveableObject);

	function Ship() {
		_classCallCheck(this, Ship);

		// Setup listeners
		var _this2 = _possibleConstructorReturn(this, (Ship.__proto__ || Object.getPrototypeOf(Ship)).call(this, document.getElementById('ship'), 50, 0));

		Object.defineProperty(_this2, 'convertLeftRightToInt', {
			enumerable: true,
			writable: true,
		...
		Object.defineProperty(_this2, 'listenToMoveShip', {
			enumerable: true,
			writable: true,
			value: function value() {
				return keyChange$.map(function (keyCode) {
					return _this2.convertLeftRightToInt(keyCode);
				}).filter(function (change) {
					return change !== 0;
				}).scan(function (acc, change) {
					return _this2.keepInBounds(acc, acc + change, 10);
				}, _this2.left).subscribe(function (left) {
					_this2.left = left;
					_this2.render();
				});
			}
		});
		Object.defineProperty(_this2, 'listenToFire', {
			enumerable: true,
			writable: true,
			value: function value() {
				var cycle = -1;
				var letters = 'PING'.split('');
				keyChange$.filter(function (code) {
					return code === 38;
				}).throttle(function () {
					return _Rx2.default.Observable.interval(200);
				}).subscribe(function () {
					if (cycle >= letters.length - 1) {
						cycle = -1;
					}
					cycle++;
					new Shot(letters[cycle], _this2.left);
				});
			}
		});
		_this2.listenToMoveShip();
		_this2.listenToFire();
		return _this2;
	}
...
var Shot = function (_MoveableObject2) {
	_inherits(Shot, _MoveableObject2);

	function Shot(letter, left) {
		_classCallCheck(this, Shot);

		var _this3 = _possibleConstructorReturn(this, (Shot.__proto__ || Object.getPrototypeOf(Shot)).call(this, null, left, 100));

		_initialiseProps.call(_this3);

		_this3.domRepresentation = _this3.createDom(letter);
		_this3.fire();
		return _this3;
	}
...
var _initialiseProps = function _initialiseProps() {
	...
	Object.defineProperty(this, 'fire', {
		...
		writable: true,
		value: function value() {
			var observer = _Rx2.default.Observable.interval(20).scan(function (acc) {
				return acc - 1;
			}, _this6.top).takeWhile(function (top) {
				return top > -10;
			}).subscribe(function (top) {
				_this6.top = top;
				_this6.render();
				if (_this6.isCollidingWith(ming)) {
	...
	Object.defineProperty(this, 'die', {
		...
		value: function value() {
			ming.die();
			document.querySelector('.field').removeChild(_this6.domRepresentation);
		}
	});
};

var Ming = function (_MoveableObject3) {
	_inherits(Ming, _MoveableObject3);

	function Ming() {
		_classCallCheck(this, Ming);

		var _this4 = _possibleConstructorReturn(this, (Ming.__proto__ || Object.getPrototypeOf(Ming)).call(this, document.querySelector('.ming'), 50, 50));

		Object.defineProperty(_this4, 'randomNum', {
			enumerable: true,
			writable: true,
		...
		Object.defineProperty(_this4, 'randomInt', {
			enumerable: true,
			writable: true,
			value: function value(min, max) {
				min = Math.ceil(min);
		...
		Object.defineProperty(_this4, 'randomlyMove', {
			enumerable: true,
			writable: true,
			value: function value() {
				return _Rx2.default.Observable.interval(2000).subscribe(function () {
					return _this4.changeDirection();
				});
			}
		});
		Object.defineProperty(_this4, 'changeDirection', {
			enumerable: true,
			writable: true,
			value: function value() {
				_this4.left = _this4.randomNum(0, 100);
				_this4.top = _this4.randomNum(0, 100);
				_this4.render();
			}
		});
		Object.defineProperty(_this4, 'die', {
			enumerable: true,
			writable: true,
			value: function value() {
				_this4.randomlyMoveObserver.unsubscribe();
				_this4.left = null;
				_this4.top = null;
				_this4.render();

				_this4.domRepresentation.classList.add('dead');
		...
		Object.defineProperty(_this4, 'reset', {
			enumerable: true,
			writable: true,
			value: function value() {
				_this4.left = 50;
				_this4.top = 50;
				_this4.domRepresentation.classList.remove('dead');
				_this4.randomlyMoveObserver = _this4.randomlyMove();
				_this4.render();
			}
		});
...
var Game = function Game() {
	...
	Object.defineProperty(this, 'showMenu', {
		enumerable: true,
		writable: true,
		value: function value() {
			_this5.menu.classList.remove('hidden');
		}
	});
	Object.defineProperty(this, 'hideMenu', {
		...
		writable: true,
		value: function value() {
			_this5.menu.classList.add('hidden');
		}
	});
